const { MessageButtonStyles, MessageButtonStylesAliases, MessageComponentTypes } = require('discord.js');

/**
 * Util class for discord-button-pagination
 */
class Util {
    /**
     * Resolve style of a button
    ...
    /**
     * Resolves button
     * @param {MessageButton} [data] MessageButton to resolve
    ...
    /**
     * Resolves component type
     * @param {MessageComponentType|String} [type] MessageComponent Type
